...
export const translations = {
  zh: {
    ...
    'services.consulting.title': '商业咨询',
    'services.consulting.description': '面向AI驱动的数字化转型和增长的战略咨询。',
  ...
  en: {
    ...
    'services.consulting.description': 'Strategic consulting for AI-driven digital transformation and growth.',
